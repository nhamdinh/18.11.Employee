...
public class DepartmentController {
    ...
    public ModelAndView saveDe(@ModelAttribute("department") Department department ){
    ...
    public ModelAndView updateDe(@ModelAttribute("department") Department department){
        departmentService.save(department);
        ModelAndView modelAndView = new ModelAndView("/department/edit");
        modelAndView.addObject("department", department);
    ...
    public String deleteDe(@ModelAttribute("department") Department department){
        departmentService.remove(department.getId());
        return "redirect:departments";
    }

    @GetMapping("/view-department/{id}")
    public ModelAndView viewDe(@PathVariable("id") Long id){
        Department department = departmentService.findById(id);
        if( department== null){
